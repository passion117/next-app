        ...
        >
          ...
          {(phoneInput) &&
            <form onSubmit={onSignInSubmit} className={styles.Content}>
              <input placeholder="08017068565" type="number" value={phoneNumber} onChange={changePhonenumber} />
              <button type="submit" id="phone-sign-in-button">次へ</button>
            </form>
          }
          {(confirmInput) &&
            <form onSubmit={onSubmitOtp} className={styles.Content}>
              <input placeholder="xxxxxx" type="number" value={verifycode} onChange={changeVerifycode} />
